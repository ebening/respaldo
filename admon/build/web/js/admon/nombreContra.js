jQuery(document).ready(function () {
    ...
    utilObject.getFuncionalidadPantalla("","NombreContraAction");
    ...
    if (jQuery('#gridVisibleNombreContra').val() == 'true') {
        ...
        // jQuery UI Dialogs
        utilDialog.setStandardDialog('#d-removeNombreContra',jQuery('#msgAlertaText').val(), jQuery('#msgDeseaEliminarText').val(), ['Aceptar@nombreContraJS.remove()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-removeSeleccionNombreContra',jQuery('#msgAlertaText').val(), jQuery('#msgDeseaEliminarSeleccionText').val(), ['Aceptar@nombreContraJS.removeSelected()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-confirmSetEstatusNombreContra',jQuery('#msgAlertaText').val(), jQuery('#msgCambiarEstatusText').val(), ['Aceptar@nombreContraJS.setEstatusSeleccion()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-noSelectedNombreContra',  jQuery('#msgError'), jQuery('#msgSeleccioneUnoOMas').val(), ['Aceptar@']);
        utilDialog.setStandardDialog('#d-registroDuplicadoNombreContra', 'Advertencia', jQuery('#msgYaExisteRegistro').val(), ['Aceptar@']);
        ...
        utilGrid.setHideElementsTable('nombreContraGridPagerId',['export']);
