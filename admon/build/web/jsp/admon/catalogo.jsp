...
<head>
<script src="<s:url value='/js/jquerycomponentes/jquery.iframe-transport.js'/>"></script>
<script src="<s:url value='/js/jquerycomponentes/jquery.fileupload.js'/>"></script>
...
<script src='<s:url value='/js/admon/catalogoParametroLenguaje.js'/>' type='text/javascript'></script>
<script src='<s:url value='/js/admon/catalogoParametro.js'/>' type='text/javascript'></script>
...
<title><s:property escape='false' value='nombreActionMenu' /></title>
</head>
<body>
	<div class='form-wrap panel-body'>
		<div class='titulo ui-corner-top'>
			...
			<div class='button-container'>
				<div class='button-custom mb-xs mt-xs mr-xs btn btn-default' id='btnNewCatalogo'>
					<s:text name='key_catalogo_bnew' />
				</div>
				<div class='button-custom mb-xs mt-xs mr-xs btn btn-primary' id='btnSaveCatalogo'>
					<s:text name='key_catalogo_bsave' />
				</div>
			</div>
			<div style='clear: both'></div>
		</div>
		<!-- Hidden -->
		<input type="hidden" id="app_context" value="<s:url value='/'/>" >
		...
		<!-- Divisor -->
		<div class='pair-wrap parametro_area' style="background-color: #F6F6F6;">
			<!-- Titulo -->
			<input type='hidden' id='key_catalogoparametro_title' value='<s:text name='key_catalogoparametro_title'/>' />
			<div class='title-text alert alert-info'>
				<s:text name='key_catalogoparametro_title' />
				<!-- BotÃ³n Agregar -->
				<div class='button-container-detalle'>
					<div class='button-custom button-detalle mb-xs mt-xs mr-xs btn btn-default' id='btnAddCatalogoParametro'>
						<s:text name='key_catalogoparametro_badd' />
					</div>
					<div class='hidden button button-detalle mb-xs mt-xs mr-xs btn btn-default' id='btnAddCatalogoParametroNoValidation'>
						<s:text name='key_catalogoparametro_badd' />
					</div>
					<div style='clear: both'></div>
				</div>
				...
				<div class='pair col-sm-4 pair-hidden'>
					...
					<s:textfield name='catalogoId' value='0' cssClass='isNumericInteger' />
                                ...
                                <div class="row">
                                    ...
                                    <div class='pair col-sm-4'>
                                            <div class='etiqueta' id='catalogoParametro_imagen'>
                                                    <s:text name='key_catalogoparametro_imagen' />
                                            </div>
                                            <input id="fileupload" type="file" name="img" data-url="<s:url value='/uploadFile'/>" multiple="multiple">
                                            <s:hidden name='imagen' />
                                            <div id="filedesc"></div>
                                    </div>
                                </div>
				<div class='pair-hidden '>
		...
		<div class='pair-wrap lenguaje_area' style="background-color: #F6F6F6;">
			<!-- Titulo -->
			<input type='hidden' id='key_catalogoparametrolenguaje_title' value='<s:text name='key_catalogoparametrolenguaje_title'/>' />
			<div class='title-text alert alert-info'>
				<s:text name='key_catalogoparametrolenguaje_title' />
				<!-- BotÃ³n Agregar -->
				<div class='button-container-detalle'>
					<div class='button-custom button-detalle mb-xs mt-xs mr-xs btn btn-default' id='btnAddCatalogoParametroLenguaje'>
						<s:text name='key_catalogoparametrolenguaje_badd' />
					</div>
					<div class='hidden button button-detalle mb-xs mt-xs mr-xs btn btn-default' id='btnAddCatalogoParametroLenguajeNoValidation'>
						<s:text name='key_catalogoparametrolenguaje_badd' />
					</div>
					<div style='clear: both'></div>
				</div>
			...
			<s:form id='catalogoParametroLenguajeform' name='catalogoParametroLenguajeform' cssClass='pair-wrap'>
				<div class='pair-hidden '>
					<div class='etiqueta' id='catalogoParametroLenguaje_filaIdText'>filaId</div>
