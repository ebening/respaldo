    ...
    <div class='form-wrap panel-body'>
        <div class='titulo ui-corner-top'>
            ...
            <div class='button-container'>
                <div class='button-custom mb-xs mt-xs mr-xs btn btn-default' id='btnNewClasificacion'><s:text name='key_clasificacioncontra_bnew'/></div>
                <div class='button-custom mb-xs mt-xs mr-xs btn btn-primary' id='btnSaveClasificacion'><s:text name='key_clasificacioncontra_bsave'/></div>
            </div>
