 ...
 * quiere actualizar su Estatus.
    ...
    public List<ZonaHoraria> getZonas(){
         return organizacionUsuarioBss.getZonas();
    }
    public List<CatalogoParametro> getPuestos(){
        return organizacionUsuarioBss.getPuestos("T_PUESTO"); 
    }
    public List<CatalogoParametro> getPreguntas(){
        return organizacionUsuarioBss.getPreguntas("T_USUARIO_REGISTRO_PREGUNTA"); 
    }
