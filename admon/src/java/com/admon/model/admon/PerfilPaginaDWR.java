 ...
 * @return Regresa una lista con los id's de los registros guardados.
     */
    public List<Integer> save(int perfilId, List<Pagina> perfilPaginaList) {
...
//        return perfilPaginaBss.findByCriteria(p, maxResult, order, ordenTipo, perfilPagina);
    ...
    public Grid findByCriteriaPerfil(int p, int maxResult, String order, String ordenTipo, Perfil perfil) {
        return perfilBss.findByCriteria(p, maxResult, order, ordenTipo, perfil);
    }
...
* @return regresa una lista de todos los registros de la tabla PAGINA
    ...
    public List<Pagina> obtienePaginas() {
        return perfilPaginaBss.obtieneArbol();
    }

    public List<String> obtienePaginasFuncionalidades(int perfilId) {
        return perfilPaginaBss.obtienePaginasFuncionalidades(perfilId);
    }
