...
public class OrganizacionDWR extends BaseModel {
    ...
    public void enviaMailOrganizacionUsuario(String usuarioLogin) {
        organizacionBss.enviaMailOrganizacionUsuario(usuarioLogin);
    }
...
//    }
    ...
    public void setEstatusUsuario(Integer estatusId, List<Integer> organizacionUsuarioList) {
        organizacionBss.setEstatusUsuario(obtieneSessionVar().getUsuarioId(), estatusId, organizacionUsuarioList);
    }
    ...
    * @param organizacionUsuarioList Lista de registros que se eliminarán en la tabla de <b>OrganizacionUsuario</b> en la BD.
     */
    public void removeOrganizacionUsuario(List<Integer> organizacionUsuarioList) {
        organizacionBss.removeOrganizacionUsuario(obtieneSessionVar().getUsuarioId(), organizacionUsuarioList);
    }
