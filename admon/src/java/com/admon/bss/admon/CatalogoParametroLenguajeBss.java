...
public interface CatalogoParametroLenguajeBss {
     ...
     * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>CatalogoParametroLenguaje</b> en la BD.
     */
    public List<Integer> update(Integer userId, List<CatalogoParametroLenguaje> catalogoParametroLenguajeList);

    /*
     * Método que elimina el registro <b>catalogoParametroLenguaje</b> en la tabla de <b>CatalogoParametroLenguaje</b>.
     * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>CatalogoParametroLenguaje</b> en la BD.
     */
     ...
     */
    //   public void setCreaEventos(Integer userId, Integer creaEventosId, List<Integer> catalogoParametroLenguajeList);
