...
public class Organizacion implements Serializable {
    ...
    private Integer servicioCompletoId;
    private Integer creaEventosId;
...
// Detalle de la organización
    ...
    /*
*Constructor de la clase Organizacion.java
     */
    public Organizacion() {
    }
    ...
    public Integer getServicioCompletoId() {
        return servicioCompletoId;
    }

    public void setServicioCompletoId(Integer servicioCompletoId) {
        this.servicioCompletoId = servicioCompletoId;
    }

    public Integer getCreaEventosId() {
        return creaEventosId;
    }

    public void setCreaEventosId(Integer creaEventosId) {
        this.creaEventosId = creaEventosId;
    }
    ...
    public String getCreaEventos() {
        return creaEventos;
    }

    public void setCreaEventos(String creaEventos) {
        this.creaEventos = creaEventos;
    }
