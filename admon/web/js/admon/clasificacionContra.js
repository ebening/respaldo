jQuery(document).ready(function () {
    ...
    utilObject.getFuncionalidadPantalla("","ClasificacionContraAction");

    // <editor-fold defaultstate="collapsed" desc="Botones">
    // Botón : NUEVO
    jQuery('#btnNewClasificacion').click(function () {
    ...
    }).customButtonEffect('#btnNewClasificacion');
    // Botón : GUARDAR
    jQuery('#btnSaveClasificacion').click(function () {
        clasificacionContraJS.prepareToSave();
    }).customButtonEffect('#btnSaveClasificacion');
    // </editor-fold>
    ...
    if (jQuery('#gridVisibleClasificacionContra').val() == 'true') {
        ...
        // jQuery UI Dialogs
        utilDialog.setStandardDialog('#d-removeClasificacionContra', jQuery('#msgAlertaText').val() , jQuery('#msgDeseaEliminarText').val(), ['Aceptar@clasificacionContraJS.remove()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-removeSeleccionClasificacionContra', jQuery('#msgAlertaText').val() , jQuery('#msgDeseaEliminarSeleccionText').val(), ['Aceptar@clasificacionContraJS.removeSelected()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-confirmSetEstatusClasificacionContra', jQuery('#msgAlertaText').val() , jQuery('#msgCambiarEstatusText').val(), ['Aceptar@clasificacionContraJS.setEstatusSeleccion()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-noSelectedClasificacionContra', jQuery('#msgError'), jQuery('#msgSeleccioneUnoOMas').val(), ['Aceptar@']);
        utilDialog.setStandardDialog('#d-registroDuplicadoClasificacionContra', 'Advertencia',  jQuery('#msgYaExisteRegistro').val(), ['Aceptar@clasificacionContraJS.doCommit()', 'Cancelar@']);
        ...
        utilGrid.setHideElementsTable('clasificacionContraGridPagerId',['export']);
        // Recargar el widget jqGrid
        clasificacionContraJS.reloadGrid();

    }
    // Limpiar la página
    jQuery('#btnNewClasificacion').click();
    // Edición externa
    ...
    if (jQuery('#gridIndividualModeClasificacionContra').val() == 'true') {
        jQuery('#btnNewClasificacion').hide();
