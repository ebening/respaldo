...
import com.admon.entity.admon.ZonaHoraria;
...
//    private List estatusOrganizacion = new ArrayList();
    ...
    private List organizacionUsuarioPerfiles = new ArrayList();
    private List organizacionUsuarioValidaMac = new ArrayList();
    private List organizacionUsuarioAplicaciones = new ArrayList();
    private List organizacionUsuarioPuestos = new ArrayList();
    private List<CatalogoParametro> organizacionUsuarioPreguntas = new ArrayList();
    private List<ZonaHoraria> organizacionUsuarioZonas = new ArrayList();;
    // Elementos de struts2 para el JSP (Embebido)
...
//        setEstatusOrganizacion(organizacionBss.getParametros("key_estatus"));
        ...
        organizacionUsuarioAplicaciones = organizacionBss.getAplicaciones();
        //TODO: Activar o inactivar por configuracion en BD
        Catalogo catalogo = new Catalogo();
        catalogo.setIgnoraMac(0);
        catalogo.setNombre("Activo");
        organizacionUsuarioValidaMac.add(catalogo);
        catalogo = new Catalogo();
        catalogo.setIgnoraMac(1);
        catalogo.setNombre("Inactivo");
        organizacionUsuarioValidaMac.add(catalogo);
        // Obtener los parámetros del catálogo Eliminado
        // por su key en com.admon.bss.resourcesCodesBss.properties
 ...
 * deben tener métodos Getter y Setter. */
 /* Getter y Setter select */
    ...
    public List getOrganizacionUsuarioPerfiles() {
        return organizacionUsuarioPerfiles;
    }


    public void setOrganizacionUsuarioPerfiles(List organizacionUsuarioPerfiles) {
        this.organizacionUsuarioPerfiles = organizacionUsuarioPerfiles;
    }

    public List getOrganizacionUsuarioAplicaciones() {
        return organizacionUsuarioAplicaciones;
    }

    public void setOrganizacionUsuarioAplicaciones(List organizacionUsuarioAplicaciones) {
        this.organizacionUsuarioAplicaciones = organizacionUsuarioAplicaciones;
    }
    
    
    public List getOrganizacionUsuarioPuestos() {
        return organizacionUsuarioPuestos;
    }

    public void setOrganizacionUsuarioPuestos(List organizacionUsuarioPuestos) {
        this.organizacionUsuarioPuestos = organizacionUsuarioPuestos;
    }
    
    public List getOrganizacionUsuarioValidaMac() {
        return organizacionUsuarioValidaMac;
    }

    public void setOrganizacionUsuarioValidaMac(List organizacionUsuarioValidaMac) {
        this.organizacionUsuarioValidaMac = organizacionUsuarioValidaMac;
    }
    
    public List getOrganizacionUsuarioPreguntas() {
        return organizacionUsuarioPreguntas;
    }

    public void setOrganizacionUsuarioPreguntas(List organizacionUsuarioPreguntas) {
        this.organizacionUsuarioPreguntas = organizacionUsuarioPreguntas;
    }
    
    public List getOrganizacionUsuarioZonas() {
        return organizacionUsuarioZonas;
    }

    public void setOrganizacionUsuarioZonas(List organizacionUsuarioZonas) {
        this.organizacionUsuarioZonas = organizacionUsuarioZonas;
    }
