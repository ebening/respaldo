...
import com.admon.entity.admon.AfiliacionSantander;

public class AfiliacionSantanderDAO extends GenericDAOImpl<AfiliacionSantander, Long> {
    ...
    @Override
    protected Class<AfiliacionSantander> getEntityClass() {
        return AfiliacionSantander.class;
    }
}