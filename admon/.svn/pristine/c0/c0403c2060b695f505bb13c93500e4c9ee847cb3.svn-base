 ...
 * método setter por cada variable que se anexa al final de la clase. */
    ...
    private ZonaHorariaBss zonaHorariaBss;
...
//        usuarioBss.save(userId, usuarioList, savedList);
        for (OrganizacionUsuario organizacionUsuario : organizacionUsuarioList) {
//            List<Usuario> usuarioList = new ArrayList();
//            Usuario usuario = new Usuario();
//            usuario.setUsuario(organizacionUsuario.getUsuarioAdmon());
//            usuario.setContrasena(organizacionUsuario.getUsuarioAdmon());
//            usuario.setNombre(organizacionUsuario.getNombre());
//            usuario.setApellidoPaterno(organizacionUsuario.getApellidoPaterno());
//            usuario.setApellidoMaterno(organizacionUsuario.getApellidoMaterno());
//            usuario.setCorreo(organizacionUsuario.getCorreo());
//            usuario.setEstatusId(organizacionUsuario.getEstatusId());
//            usuario.setEliminadoId(organizacionUsuario.getEliminadoId());
//            usuarioList.add(usuario);
//            List<Integer> users = usuarioBss.save(userId, usuarioList, null);
//            Integer usuarioId = null;
//            if(users != null && !users.isEmpty()){
//                usuarioId = users.get(0);
//            }
...
//            organizacionUsuario.setUsuarioId(usuarioId);
...
//            List<Usuario> usuarioList = new ArrayList();
//            Usuario usuario = new Usuario();
//            usuario.setUsuarioId(organizacionUsuario.getUsuarioId());
//            usuario.setUsuario(organizacionUsuario.getUsuarioAdmon());
//            usuario.setContrasena(organizacionUsuario.getUsuarioAdmon());
//            usuario.setNombre(organizacionUsuario.getNombre());
//            usuario.setApellidoPaterno(organizacionUsuario.getApellidoPaterno());
//            usuario.setApellidoMaterno(organizacionUsuario.getApellidoMaterno());
//            usuario.setCorreo(organizacionUsuario.getCorreo());
//            usuario.setCreacionFecha(organizacionUsuario.getCreacionFecha());
//            usuario.setCreacionUsuario(organizacionUsuario.getCreacionUsuario());
//            usuario.setEstatusId(organizacionUsuario.getEstatusId());
//            usuario.setEliminadoId(organizacionUsuario.getEliminadoId());
//            usuarioList.add(usuario);
//            usuarioBss.update(userId, usuarioList, null);
            ...
            for (OrganizacionUsuario organizacionUsuario : list) {
                ...
                if (organizacionUsuario.getModificacionUsuario() != null) {
                    for (Usuario o : usuarioList) {
                        if (o.getUsuarioId().intValue() == organizacionUsuario.getModificacionUsuario().intValue()) {
                ...
                organizacionUsuario.setFechaModificacion("");
                if (organizacionUsuario.getModificacionUsuario() != null) {
                    organizacionUsuario.setFechaModificacion(dateFormat.format(organizacionUsuario.getModificacionFecha()));
            }
                
                organizacionUsuario.setPerfil("");
                if(organizacionUsuario.getPerfilId() != null) {
                    Perfil perfil = perfilBss.findById(organizacionUsuario.getPerfilId());
                    if(perfil != null){
                        organizacionUsuario.setPerfil(perfil.getNombre());  
        }
                }
                
                organizacionUsuario.setConfirmarContrasena("");
                if (organizacionUsuario.getContrasena() != null) {
                    organizacionUsuario.setConfirmarContrasena(organizacionUsuario.getContrasena());
                }
 ...
 * una edición de datos en un popup externo.
    ...
    public List<ZonaHoraria> getZonas(){
         return getZonaHorariaBss().findAll();
    }
    
    @Override
    public List<CatalogoParametro> getPuestos(String clave){
        Catalogo catalogo = new Catalogo();
        catalogo.setClave(clave);
        Catalogo c = getCatalogoBss().findByCriteriaIgnorePrivacy(catalogo).get(0);
        CatalogoParametro catalogoParametro = new CatalogoParametro();
        catalogoParametro.setCatalogoId(c.getCatalogoPK().getCatalogoId());
        return getCatalogoParametroBss().findByIntProperty("catalogoId",c.getCatalogoPK().getCatalogoId(),"valor");
    }
    @Override
    public List<CatalogoParametro> getPreguntas(String clave){
        Catalogo catalogo = new Catalogo();
        catalogo.setClave(clave);
        Catalogo c = getCatalogoBss().findByCriteriaIgnorePrivacy(catalogo).get(0);
        CatalogoParametro catalogoParametro = new CatalogoParametro();
        catalogoParametro.setCatalogoId(c.getCatalogoPK().getCatalogoId());
        return getCatalogoParametroBss().findByIntProperty("catalogoId",c.getCatalogoPK().getCatalogoId());
    }
     
    public ZonaHorariaBss getZonaHorariaBss() {
        return zonaHorariaBss;
    }
    
    public CatalogoBss getCatalogoBss() {
        return catalogoBss;
    }
    
    public CatalogoParametroBss getCatalogoParametroBss() {
        return this.catalogoParametroBss;
    }
 ...
 * Setter.
    ...
    public void setZonaHorariaBss(ZonaHorariaBss zonaHorariaBss) {
        this.zonaHorariaBss = zonaHorariaBss;
    }
