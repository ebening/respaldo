...
import com.admon.bss.admon.ParcializacionBanamexBss;

public class ParcializacionBanamexDWR extends BaseModel {
 ...
 * método setter por cada variable que se anexa al final de la clase.
     */
    private ParcializacionBanamexBss parcializacionBanamexBss;

    public ParcializacionBanamexDWR() {
    }
 ...
 * @return Regresa una lista con los id's de los registros guardados.
     */
    public List<Integer> save(List<ParcializacionBanamex> afiliacionList) {
        return parcializacionBanamexBss.save(obtieneSessionVar().getUsuarioId(), afiliacionList);
    }
 ...
 * @param perfilList Lista de registros que se actualizarán en la tabla de <b>AfiliacionBanamex</b> en la BD.
     */
    public List<String> update(List<ParcializacionBanamex> afiliacionList) {
        return parcializacionBanamexBss.update(obtieneSessionVar().getUsuarioId(), afiliacionList);
    }
 ...
 * @param perfilList Lista de registros que se eliminarán en la tabla de <b>AfiliacionBanamex</b> en la BD.
    ...
    public void remove(List<Integer> afiliacionIdList) {
        parcializacionBanamexBss.delete(obtieneSessionVar().getUsuarioId(), afiliacionIdList);
    }
 ...
 * registro con ese nombre regresa un <b>true</b>.
    ...
    public boolean isValidoNombre(String nombre) {
      //  return afiliacionBanamexBss.isValidoNombre(nombre);
      return true;
    }
 ...
 * @return Regresa un objeto tipo <b>AfiliacionBanamex</b> con la información del registro <b>perfil</b>.
    ...
    public ParcializacionBanamex  findById(Integer afiliacionBanamexId) {
        return parcializacionBanamexBss.findById(afiliacionBanamexId);
    }
/*
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
     */
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, ParcializacionBanamex afiliacion, String nombreAfiliacion) {
        return parcializacionBanamexBss.findByCriteria(p, maxResult, order, ordenTipo, afiliacion, nombreAfiliacion);
    }
    ...
    public ParcializacionBanamex findFirst() {
        return parcializacionBanamexBss.findFirst();
    }
    // </editor-fold>

    public String getReportDataTest(String order, String ordenTipo, ParcializacionBanamex afiliacion, String nombreAfiliacion) {
        return parcializacionBanamexBss.getReportDataTest(order, ordenTipo, afiliacion, nombreAfiliacion);
    }
 ...
 * Setter.
     ...
     */
    public void setParcializacionBanamexBss(ParcializacionBanamexBss parcializacionBanamexBss) {
        this.parcializacionBanamexBss = parcializacionBanamexBss;
    }
