    ...
    <div class='form-wrap panel-body'>
        ...
        <s:form id='subclasificacionContraform' name='subclasificacionContraform' cssClass='pair-wrap'>
            ...
            <div class='pair col-sm-4'>
                <span class='etiqueta-small required_star col-xs-10_star' id='subclasificacionContra_clasificacionContraIdText'>
            ...
            <div class='pair col-sm-4'>
                <div class='etiqueta required_star col-xs-10_star' id='subclasificacionContra_nombreText'>
                    <s:text name='key_subclasificacioncontra_nombre'/>
                </div>
                <s:textfield name='nombre' maxLength='187' cssClass='textbox form-control'/>
            </div>
            <div class='pair col-sm-4'>
                <div class='etiqueta required_star col-xs-10_star' id='subclasificacionContra_ordenText'>
