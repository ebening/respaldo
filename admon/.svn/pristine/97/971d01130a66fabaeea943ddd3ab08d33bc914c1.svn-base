...
public interface ParcializacionSantanderBss {
 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>ParcializacionSantander</b> en la BD.
     */
    public List<Long> update(Integer userId, List<ParcializacionSantander> objList);

    /*
 * Método que elimina el registro <b>ParcializacionSantander</b> en la tabla de <b>ParcializacionSantander</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>ParcializacionSantander</b> en la BD.
     */
 ...
 * @return Regresa un objeto tipo <b>ParcializacionSantander</b> con la información de la consulta.
    ...
    /*
 * Método que busca el registro <b>ParcializacionSantander</b> por su ID en la tabla de <b>ParcializacionSantander</b>.
 * @param id es el ID del registro que se quiere obtener.
 * @return Regresa un objeto tipo <b>ParcializacionSantander</b> con la información del registro <b>ParcializacionSantander</b>.
     */
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
     */
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, ParcializacionSantander obj);
 ...
 * una edición de datos en un popup externo.
     ...
     * (CONFIGURACION_PARAMETRO) campo ParcializacionSantander.
     *
