...
public class ParcializacionSantanderDAO extends GenericDAOImpl<ParcializacionSantander, Long> {
    ...
    @Override
    protected Class<ParcializacionSantander> getEntityClass() {
        return ParcializacionSantander.class;
    }
