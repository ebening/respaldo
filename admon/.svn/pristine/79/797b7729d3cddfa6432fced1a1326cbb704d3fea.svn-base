...
public interface AplicacionBss {
 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>Aplicacion</b> en la BD.
     */
    public List<Long> update(Integer userId, List<Aplicacion> aplicacionList);

    /*
 * Método que elimina el registro <b>aplicacion</b> en la tabla de <b>Aplicacion</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>Aplicacion</b> en la BD.
     */
 ...
 * @return Regresa un objeto tipo <b>Aplicacion</b> con la información de la consulta.
    ...
    /*
 * Método que busca el registro <b>aplicacion</b> por su ID en la tabla de <b>Aplicacion</b>.
 * @param id es el ID del registro que se quiere obtener.
 * @return Regresa un objeto tipo <b>Aplicacion</b> con la información del registro <b>aplicacion</b>.
     */
    ...
    /*
 * Método que hace una consulta a la tabla Aplicacion y obtiene los registros que coincidan con el objeto <b>aplicacion</b> que es mandado como parámetro en el método. Los resultados de la consulta son páginados y encapsulados en un objeto <b>Grid</b>para que puedan ser mostrados correctamente en el widget JQGrid del JSP.
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
     */
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, Aplicacion aplicacion);
 ...
 * una edición de datos en un popup externo.
     ...
     * (CONFIGURACION_PARAMETRO) campo Aplicacion.
     *
