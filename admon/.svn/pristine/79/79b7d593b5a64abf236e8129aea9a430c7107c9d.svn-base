...
//                jQuery('#organizacion_servicioCompletoIdText').html(),
                ...
                jQuery('#organizacion_creaEventosIdText').html(),
                jQuery('#organizacion_servicioCompletoIdText').html(),
                jQuery('#generico_modificar').val(),jQuery('#generico_eliminar').val()],
            colModel: [{
                    name: 'organizacionId',
...
//                    search: true
        ...
        utilDialog.setStandardDialog('#d-confirma-enviar-mail-organizacionusuario', 'Aviso', '&iquest;Desea enviar los datos del usuario por correo?', ['Aceptar@organizacionUsuarioJS.enviaMail();', 'Cancelar@']);
    ...
    if (jQuery('#gridVisibleOrganizacionUsuario').val() == 'true') {
        jQuery('#organizacionUsuarioGrid').jqGrid({
            ...
            colNames: [
                ...
                jQuery('#organizacionUsuario_usuarioIdText').html(),
                ...
                jQuery('#organizacionUsuario_PuestoIdText').html(),
                jQuery('#organizacionUsuario_descripcionText').html(),
                jQuery('#organizacionUsuario_preguntaIdText').html(),
                jQuery('#organizacionUsuario_respuestaText').html(),
                jQuery('#organizacionUsuario_ZonaIdText').html(),
                jQuery('#organizacionUsuario_FechaFinVigenciaText').html(),
                jQuery('#organizacionUsuario_FechaUltimaSesionText').html(),
                jQuery('#organizacionUsuario_ignoraMacText').html(),
                jQuery('#organizacionUsuario_correoText').html(),
                jQuery('#organizacionUsuario_correoAlternoText').html(),
                jQuery('#organizacionUsuario_telefonoText').html(),
                jQuery('#organizacionUsuario_extensionText').html(),
                jQuery('#organizacionUsuario_celularText').html(),
                ...
                jQuery('#organizacionUsuario_fechaModificacionText').html(),
            ...
            colModel: [{
                    ...
                    name: 'fechaUltimaSesion',
                    index: 'fechaUltimaSesion',
                    align: 'center',
                    resizable: false,
                    hidden: true,
                    search: false
    ...
    perfilAplicacionJS.inicializarGrid();
//inicia funcionalidad de los tabs
    modsJS.iniTab();
    utilGrid.autoWidthGrid();

    utilObject.getFuncionalidadPantalla("","OrganizacionAction");
...
var modsJS = {
    ...
    setGridWidthModf: function () {
        ...
        jQuery('#perfilAplicacionGrid').setGridWidth(
                jQuery("#gbox_" + "perfilAplicacionGrid").closest(".grid-container").width() - 1);
    },
...
var organizacionUsuarioJS = {
    ...
    agregar: function () {
        ...
        organizacionUsuarioJS.setNombreUsuario(organizacionUsuario.usuarioAdmon);
        ...
        organizacionUsuarioJS.save(jQuery('#organizacionform_organizacionId').val());
    },
    ...
    agregarNuevo: function (object) {
        ...
        var eliminar_css = 'ui-icon ui-icon-trash ui-icon-center';
        var eliminar_title = 'Eliminar';
        var eliminar_onclick = 'organizacionUsuarioJS.prepareToRemove(' + filaId + ',' + object.organizacionUsuarioId + ' )';
        object.Edit = "<span class = '" + editar_css +
                "' title = '" + editar_title +
                "' style = 'cursor:pointer' onclick = '" + editar_onclick + "'></span>";
        object.Remove = "<span class = '" + eliminar_css +
        ...
        // Activo
        var estatus_activo_css = 'ui-icon ui-icon-bullet ui-icon-center';
        var estatus_activo_title = 'Activo';
        var estatus_activo_onclick = 'organizacionUsuarioJS.setEstatusUsuario( ' + object.organizacionUsuarioId + ', 2 )';
        // Inactivo
        var inactivo_css = 'ui-icon ui-icon-radio-off ui-icon-center';
        var inactivo_title = 'Inactivo';

        var inactivo_onclick = 'organizacionUsuarioJS.setEstatusUsuario( ' + object.organizacionUsuarioId + ', 1 )';
        
        var estatus_css = 'ui-icon ui-icon-bullet ui-icon-center';
        var estatus_title = 'Activo';
        var estatus_onclick = '';

        if(object.estatusId===1 || object.estatusId===-1) {
           estatus_css = estatus_activo_css;
           estatus_onclick = estatus_activo_onclick;
        } else {
            estatus_title = 'Inactivo';
    ...
    findByFilaId: function (filaId) {
        ...
        for (var i = 0; i < filas.length; i++) {
            if (filas[ i ].filaId == filaId) {
                ...
                jQuery("#organizacionUsuarioform_ignoraMac"+filas[i].ignoraMac).prop("checked", true );
                utilForm.populate('#organizacionUsuarioform', filas[ i ]);
                break;
            }
        }
        jQuery('#perfilAplicacionDiv').show();
        utilGrid.autoWidthGrid();
        perfilAplicacionJS.setOrganizacionId(filas[i].organizacionId);
        perfilAplicacionJS.setUsuarioId(filas[i].organizacionUsuarioId);
        perfilAplicacionJS.findByCriteria(filas[i]);
    },
    /** 
     * Función llamada al presionar el botón Eliminar en el registro de
     * organizacionUsuario.
     ...
     * @param filaId, es el numero de la fila.
     */
    prepareToRemove: function (filaId, organizacionUsuarioId) {
        organizacionUsuarioJS.filaId = filaId;
        organizacionUsuarioJS.setEliminarId(organizacionUsuarioId);
    ...
    remove: function () {
        ...
        var listaIds = [id];
        OrganizacionDWR.removeOrganizacionUsuario(listaIds, organizacionUsuarioJS.removeCallback);
    },
    /*
    ...
    setNombreUsuario: function (nombreUsuario) {
        organizacionUsuarioJS.nombreUsuario = nombreUsuario;
    },
    /*
     * Getter de la variable eliminarId
     **/
    getNombreUsuario: function () {
        return organizacionUsuarioJS.nombreUsuario;
    },
    correoUsuario: '',
    /*
     * Setter de la variable eliminarId
     **/
    setCorreoUsuario: function (correoUsuario) {
        organizacionUsuarioJS.correoUsuario = correoUsuario;
    },
    /*
     * Getter de la variable eliminarId
     **/
    getCorreoUsuario: function () {
        return organizacionUsuarioJS.correoUsuario;
    },
    organizacionUsuarioId: '',
     /*
     * Setter de la variable eliminarId
     **/
    setOrganizacionUsuarioId: function (organizacionUsuarioId) {
        organizacionUsuarioJS.organizacionUsuarioId = organizacionUsuarioId;
    },
    /*
     * Getter de la variable eliminarId
     **/
    getOrganizacionUsuarioId: function () {
        return organizacionUsuarioJS.organizacionUsuarioId;
    },
    /** 
     * Guarda los registros del detalle.
     * 
    ...
    saveCallback: function () {
        organizacionUsuarioJS.findOrganizacionUsuarioByIntProperty(jQuery('#organizacionform_organizacionId').val());
        //utilEffect.showToast('success', jQuery('#msgGuardadoOk').val());
        utilDialog.showDialog('#d-confirma-enviar-mail-organizacionusuario');
    },
    ...
    findOrganizacionUsuarioByIntPropertyCallback: function (data) {
        ...
        if (data != null) {
         ...
         //Lenar combos de tab Usuario
        var currentdate = new Date();
        currentdate.setDate(currentdate.getDate() + 365);
        currentdate = utilForm.getValorDateTime(currentdate);
        jQuery('#organizacionUsuarioform_fechaVigencia').val(currentdate);
         organizacionUsuarioJS.getPuestos();
        utilEffect.hideProgressBar();
    },
    enviaMail: function(){
         var nombre = organizacionUsuarioJS.getNombreUsuario();
        OrganizacionDWR.enviaMailOrganizacionUsuario(nombre, organizacionUsuarioJS.enviaMailCallback); 
    },
    enviaMailCallback: function(){
      utilEffect.showToast('success', jQuery('#msgGuardadoOk').val());  
    },
    /*
     ...
     * @param estatusId (int) Es el nuevo estatusId
     */
    setEstatusUsuario: function (id, estatusId) {
        utilEffect.showProgressBar();
        var listaObjetos = [id];
        OrganizacionDWR.setEstatusUsuario(estatusId, listaObjetos, organizacionUsuarioJS.setEstatusCallback);
    },
        /*
    ...
    getPuestos: function(){
        utilEffect.showProgressBar();
        OrganizacionUsuarioDWR.getPuestos(function(data){
         var options = $("#organizacionUsuarioform_puestoId");
         options.empty();
         options.append($("<option />").val("-1").text("--Seleccione--"));
         $.each(data, function() {
                options.append($("<option />").val(this.catalogoParametroPK.catalogoParametroId).text(this.valor));
         });
            utilEffect.hideProgressBar();
            organizacionUsuarioJS.getZonas();
        });
    },
    getZonas: function(){
        utilEffect.showProgressBar();
        OrganizacionUsuarioDWR.getZonas(function(data){
         var options = $("#organizacionUsuarioform_zonaId");
         options.empty();
         options.append($("<option />").val("-1").text("--Seleccione--"));
         $.each(data, function() {
             options.append($("<option />").val(this.zonaId).text(this.nombre));
         });
            utilEffect.hideProgressBar();
            organizacionUsuarioJS.getPreguntas();
        });
    },
    getPreguntas: function(){
        $("#organizacionUsuarioform_zonaId").val(jQuery('#zonaIdDefault').val());
        utilEffect.showProgressBar();
        OrganizacionUsuarioDWR.getPreguntas(function(data){
         var options = $("#organizacionUsuarioform_preguntaId");
         options.empty();
         options.append($("<option />").val("-1").text("--Seleccione--"));
         $.each(data, function() {
...
//        organizacionGenerarJS.reloadGrid();
    ...
    findByIdCallback: function (data) {
        ...
        utilInput.addDummyToSelect('#organizacionform_estadoId', '--Seleccione--');
        utilInput.addDummyToSelect('#organizacionform_ciudadId', '--Seleccione--');
        jQuery('#organizacionform_paisId').change();
        jQuery('#organizacionform_estadoId').change();
...
validanguage.el.organizacionUsuarioform_puestoId = {
    characters: {
        mode: 'allow', expression: 'numeric-', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter, {
            name: function (_evt) {
                if (jQuery('#organizacionUsuarioform_puestoId').val() <= 0) {
                    return false;
                } else {
                    return true;
                }
...
validanguage.el.organizacionUsuarioform_descripcion = {
    characters: {
        mode: 'allow', expression: 'alphanumeric ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter, {
...
validanguage.el.organizacionUsuarioform_preguntaId = {
    characters: {
        mode: 'allow', expression: 'numeric-', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter, {
            name: function (_evt) {
                if (jQuery('#organizacionUsuarioform_preguntaId').val() <= 0) {
                    return false;
                } else {
                    return true;
                }
...
validanguage.el.organizacionUsuarioform_respuesta = {
    characters: {
        mode: 'allow', expression: 'alphanumeric ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter, {
...
validanguage.el.organizacionUsuarioform_zonaId = {
    characters: {
        mode: 'allow', expression: 'numeric-', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter, {
            name: function (_evt) {
                if (jQuery('#organizacionUsuarioform_zonaId').val() <= 0) {
                    return false;
                } else {
                    return true;
                }
...
validanguage.el.organizacionUsuarioform_correo = {
    characters: {
        mode: 'allow', expression: 'alphanumericspecial ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileRequiredField, ProfileCheckForInvalidCharacter,ProfileMail]};
validanguage.el.organizacionUsuarioform_correoAlterno = {
    characters: {
        mode: 'allow', expression: 'alphanumericspecial ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter,ProfileMail]};

validanguage.el.organizacionUsuarioform_telefono = {
    characters: {
        mode: 'allow', expression: 'numeric ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter,{
...
validanguage.el.organizacionUsuarioform_extencion = {
    characters: {
        mode: 'allow', expression: 'numeric ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter,{
...
validanguage.el.organizacionUsuarioform_celular = {
    characters: {
        mode: 'allow', expression: 'numeric ', suppress: false},
    validations: [
        ProfileStripWhitespace, ProfileCheckForInvalidCharacter,{
