...
public interface AfiliacionSantanderBss {
 ...
 * @return Regresa una lista con los id's de los registros guardados.
    ...
    public void saveConfiguracionParametro(int userId, int objId,
 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>AfiliacionSantander</b> en la BD.
     */
    public List<Long> update(Integer userId, List<AfiliacionSantander> objList);

    /*
 * Método que elimina el registro <b>AfiliacionSantander</b> en la tabla de <b>AfiliacionSantander</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>AfiliacionSantander</b> en la BD.
     */
    public void delete(Integer userId, List<Long> objIdList);
 ...
 * registro con ese nombre regresa un <b>true</b>.
    ...
    /*
 * Método que busca el registro <b>parcializacionSantander</b> por su NOMBRE en la tabla de <b>AfiliacionSantander</b>.
 ...
 * @return Regresa un objeto tipo <b>AfiliacionSantander</b> con la información de la consulta.
    ...
    /*
 * Método que busca el registro <b>AfiliacionSantander</b> por su ID en la tabla de <b>AfiliacionSantander</b>.
 * @param id es el ID del registro que se quiere obtener.
 * @return Regresa un objeto tipo <b>AfiliacionSantander</b> con la información del registro <b>AfiliacionSantander</b>.
     */
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
     */
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, AfiliacionSantander obj);
 ...
 * una edición de datos en un popup externo.
     ...
     * (CONFIGURACION_PARAMETRO) campo AfiliacionSantander.
     *
