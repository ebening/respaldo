...
import com.admon.bss.admon.ParcializacionSantanderBss;
import com.admon.entity.admon.ParcializacionSantander;
import com.admon.entity.admon.*;
import com.admon.model.BaseModel;
import java.util.List;

public class ParcializacionSantanderDWR extends BaseModel {
 ...
 * método setter por cada variable que se anexa al final de la clase.
     */
    private ParcializacionSantanderBss parcializacionSantanderBss;

    public ParcializacionSantanderDWR() {
    }
 ...
 * @return Regresa una lista con los id's de los registros guardados.
    ...
    public List<Long> save(List<ParcializacionSantander> objList) {
        return parcializacionSantanderBss.save(obtieneSessionVar().getUsuarioId(), objList);
    }
...
//        return parcializacionSantanderBss.saveConfiguracionParametro(obtieneSessionVar().getUsuarioId(), objList);
//    }
    
//    public List<Long> updateParcializacionSantanderParametro(List<Parametro> objList) {
//        return parcializacionSantanderBss.updateParcializacionSantanderParametro(obtieneSessionVar().getUsuarioId(), objList);
//    }
 ...
 * @param objList Lista de registros que se actualizarán en la tabla de <b>ParcializacionSantander</b> en la BD.
    ...
    public List<Long> update(List<ParcializacionSantander> objList) {
        return parcializacionSantanderBss.update(obtieneSessionVar().getUsuarioId(), objList);
    }
 ...
 * @param objList Lista de registros que se eliminarán en la tabla de <b>ParcializacionSantander</b> en la BD.
    ...
    public void remove(List<Long> paginaIdList) {
        parcializacionSantanderBss.delete(obtieneSessionVar().getUsuarioId(), paginaIdList);
    }
 ...
 * registro con ese nombre regresa un <b>true</b>.
    ...
    public boolean isValidoNombre(String nombre) {
        return parcializacionSantanderBss.isValidoNombre(nombre);
    }
 ...
 * @return Regresa un objeto tipo <b>ParcializacionSantander</b> con la información del registro <b>pagina</b>.
    ...
    public ParcializacionSantander findById(Long id) {
        return parcializacionSantanderBss.findById(id);
    }
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
    ...
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, ParcializacionSantander pagina) {
        return parcializacionSantanderBss.findByCriteria(p, maxResult, order, ordenTipo, pagina);
    }
    ...
    public ParcializacionSantander findFirst() {
        return parcializacionSantanderBss.findFirst();
    }
 ...
 * una edición de datos en un popup externo.
    ...
    public String getReportDataTest(String order, String ordenTipo, ParcializacionSantander pagina) {
        return parcializacionSantanderBss.getReportDataTest(order, ordenTipo, pagina);
    }
    /*
 ...
 * Setter.
     */
    public void setParcializacionSantander(ParcializacionSantanderBss parcializacionSantanderBss) {
        this.parcializacionSantanderBss = parcializacionSantanderBss;
    }
