...
import com.admon.entity.admon.PaginaAccion;

public class PaginaAccionDAO extends GenericDAOImpl<PaginaAccion, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<PaginaAccion> getEntityClass() {
        return PaginaAccion.class;
    }
}
