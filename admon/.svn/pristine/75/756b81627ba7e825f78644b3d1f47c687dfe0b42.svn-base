...
import com.admon.entity.admon.ParcializacionBanamex;

public class ParcializacionBanamexDAO extends GenericDAOImpl<ParcializacionBanamex, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<ParcializacionBanamex> getEntityClass() {
        return ParcializacionBanamex.class;
    }
}
