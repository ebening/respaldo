...
import com.admon.entity.admon.ClasificacionContra;

public class ClasificacionContraDAO extends GenericDAOImpl<ClasificacionContra, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<ClasificacionContra> getEntityClass() {
        return ClasificacionContra.class;
    }
}
