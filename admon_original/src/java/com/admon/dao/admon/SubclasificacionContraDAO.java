...
import com.admon.entity.admon.SubclasificacionContra;

public class SubclasificacionContraDAO extends GenericDAOImpl<SubclasificacionContra, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<SubclasificacionContra> getEntityClass() {
        return SubclasificacionContra.class;
    }
}
