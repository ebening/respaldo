...
public class ConfiguracionParametroDWR extends BaseModel {
 ...
 * método setter por cada variable que se anexa al final de la clase.
    ...
    public ConfiguracionParametroDWR() {
    }

    /*
 * Guarda la lista <b>configuracionParametroList</b> en la tabla <b>ConfiguracionParametro</b>.
 * @param configuracionParametroList Lista a guardar.
 * @return Regresa una lista con los id's de los registros guardados.
     */
    public List<Integer> save(List<ConfiguracionParametro> configuracionParametroList) {
        return configuracionParametroBss.save(obtieneSessionVar().getUsuarioId(), configuracionParametroList);
    }

    /*
 * Método que actualiza la información de <b>configuracionParametro</b> en la tabla de <b>ConfiguracionParametro</b>.
 * @param configuracionParametroList Lista de registros que se actualizarán en la tabla de <b>ConfiguracionParametro</b> en la BD.
     */
    public List<Integer> update(List<ConfiguracionParametro> configuracionParametroList) {
        return configuracionParametroBss.update(obtieneSessionVar().getUsuarioId(), configuracionParametroList);
    }
 ...
 * @param configuracionParametroList Lista de registros que se eliminarán en la tabla de <b>ConfiguracionParametro</b> en la BD.
     */
    public void remove(List<Integer> configuracionParametroIdList) {
        configuracionParametroBss.delete(obtieneSessionVar().getUsuarioId(), configuracionParametroIdList);
    }
 ...
 * registro con ese nombre regresa un <b>true</b>.
    ...
    public boolean isValidoNombre(String nombre) {
        return configuracionParametroBss.isValidoNombre(nombre);
    }
 ...
 * @return Regresa un objeto tipo <b>ConfiguracionParametro</b> con la información del registro <b>configuracionParametro</b>.
    ...
    public ConfiguracionParametro findById(Integer configuracionParametroId) {
        return configuracionParametroBss.findById(configuracionParametroId);
    }
 ...
 * @return Regrega un objeto <b>Grid</b> con los datos a mostrar en la pantalla.
    ...
    public Grid findByCriteria(int p, int maxResult, String order, String ordenTipo, ConfiguracionParametro configuracionParametro) {
        return configuracionParametroBss.findByCriteria(p, maxResult, order, ordenTipo, configuracionParametro);
    }
    ...
    public ConfiguracionParametro findFirst() {
        return configuracionParametroBss.findFirst();
    }
 ...
 * quiere actualizar su Estatus.
     */
    public void setEstatus(Integer estatusId, List<Integer> configuracionParametroList) {
        configuracionParametroBss.setEstatus(obtieneSessionVar().getUsuarioId(), estatusId, configuracionParametroList);
    }
 ...
 * una edición de datos en un popup externo.
    ...
    public String getReportDataTest(String order, String ordenTipo, ConfiguracionParametro configuracionParametro) {
        return configuracionParametroBss.getReportDataTest(order, ordenTipo, configuracionParametro);
    }
