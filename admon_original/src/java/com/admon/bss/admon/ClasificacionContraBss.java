...
public interface ClasificacionContraBss {
 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>ClasificacionContra</b> en la BD.
     */
    public List<Integer> update(Integer userId, List<ClasificacionContra> clasificacionContraList);

    /*
 * Método que elimina el registro <b>clasificacionContra</b> en la tabla de <b>ClasificacionContra</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>ClasificacionContra</b> en la BD.
     */
