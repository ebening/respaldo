...
public class CatalogoParametroLenguaje implements Serializable {

//    private Integer catalogoParametroLenguajeId;
//    private Integer organizacionId;
    private CatalogoParametroLenguajePK catalogoParametroLenguajePK;
    ...
    //Campos auxiliares
    private String catalogoParametro;
    ...
    public CatalogoParametroLenguaje() {
    }
...
//    }
    public CatalogoParametroLenguajePK getCatalogoParametroLenguajePK() {
        return catalogoParametroLenguajePK;
    }

    public void setCatalogoParametroLenguajePK(CatalogoParametroLenguajePK catalogoParametroLenguajePK) {
        this.catalogoParametroLenguajePK = catalogoParametroLenguajePK;
    }
    ...
    public String getCatalogoParametro() {
        return catalogoParametro;
    }

    public void setCatalogoParametro(String catalogoParametro) {
