jQuery(document).ready(function () {
    ...
    if (jQuery('#gridVisibleSubclasificacionContra').val() == 'true') {
        ...
        // jQuery UI Dialogs
        utilDialog.setStandardDialog('#d-removeSubclasificacionContra', 'Confirme', '¿Desea eliminar el registro?', ['Aceptar@subclasificacionContraJS.remove()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-removeSeleccionSubclasificacionContra', 'Confirme', '¿Desea eliminar los registros seleccionados?', ['Aceptar@subclasificacionContraJS.removeSelected()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-confirmSetEstatusSubclasificacionContra', 'Confirme', '¿Desea cambiar el estatus de los registros seleccionados?', ['Aceptar@subclasificacionContraJS.setEstatusSeleccion()', 'Cancelar@']);
        utilDialog.setStandardDialog('#d-noSelectedSubclasificacionContra', 'Error', 'Para poder realizar esta operación seleccione uno ó más registros.', ['Aceptar@']);
        utilDialog.setStandardDialog('#d-registroDuplicadoSubclasificacionContra', 'Advertencia', 'Ya existe un registro con este nombre en la base de datos, ¿Desea crear un nuevo registro con este nombre?', ['Aceptar@subclasificacionContraJS.doCommit()', 'Cancelar@']);
...
var subclasificacionContraJS = {
    ...
    isValidoNombre: function () {
        ...
        SubclasificacionContraDWR.isValidoNombre(nombre, subclasificacionContraJS.isValidoNombreCallback);
    },
    /*
