 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>Ciudad</b> en la BD.
     */
    public List<Integer> update(Integer userId, List<Ciudad> ciudadList);

    /*
 * Método que elimina el registro <b>ciudad</b> en la tabla de <b>Ciudad</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>Ciudad</b> en la BD.
     */
 ...
 * @return Regresa un objeto tipo <b>Ciudad</b> con la información del registro <b>ciudad</b>.
    ...
    /*
 * Método que hace una consulta a la tabla Ciudad y obtiene los registros que coincidan con el objeto <b>ciudad</b> que es mandado como parámetro en el método. Los resultados de la consulta son páginados y encapsulados en un objeto <b>Grid</b>para que puedan ser mostrados correctamente en el widget JQGrid del JSP.
