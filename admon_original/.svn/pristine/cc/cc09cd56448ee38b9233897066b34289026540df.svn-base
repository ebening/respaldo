...
import com.admon.entity.admon.OrganizacionCredencial;

public class OrganizacionCredencialDAO extends GenericDAOImpl<OrganizacionCredencial, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<OrganizacionCredencial> getEntityClass() {
        return OrganizacionCredencial.class;
    }
}
