...
public interface ConfiguracionBss {
 ...
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se actualizarán en la tabla de <b>Configuracion</b> en la BD.
     */
    public List<Integer> update(Integer userId, List<Configuracion> configuracionList);

    /*
 * Método que elimina el registro <b>configuracion</b> en la tabla de <b>Configuracion</b>.
 * @param userId Es el id del usuario que realizó la operación. * @param objectList Lista de registros que se eliminarán en la tabla de <b>Configuracion</b> en la BD.
     */
 ...
 * una edición de datos en un popup externo.
     ...
     * (CONFIGURACION_PARAMETRO) campo Configuracion.
     *
