...
//                }
    ...
    public boolean addCredencialesJSON(int organizacionId, List<ConfiguracionParametro> rutasList, OrganizacionGenerar organizacionGenerar) {
        ...
        if (!listOrgCred.isEmpty()) {
            System.out.println("::::::::::::: listOrgCred ::::::::::::: " + listOrgCred.size());
    ...
    private boolean modificaJson(JSONObject objson, String organizacionId, String ruta) {
        ...
        try {
            System.out.println("::::::::::::: objson ::::::::::::: " + objson);
            ...
            System.out.println("::::::::::::: data   ::::::::::::: " + arrCred);
            boolean found = false;
            String rutaAux = "";
            ...
            rutaAux = objIn.toJSONString();
            rutaAux = rutaAux.replace("\\/", "/");
            System.out.println("::::::::::::: rutaAux ::::::::::::: " + rutaAux);
            FileWriter file = new FileWriter(ruta.concat("credenciales.json"));
            System.out.println("::::::::::::: ruta ::::::::::::: " + ruta.concat("credenciales.json"));
            file.write(rutaAux);
            file.flush();
            file.close();
    ...
    private boolean copiaOrg(File origen, File destino) {
        System.out.println("::::::::::::: origen length ::::::::::::: " + origen.length());
        System.out.println("::::::::::::: destino length ::::::::::::: " + destino.length());
        if (origen.exists()) {
            try {
    ...
    private boolean copiarDirectorios(String d1, String d2) {
        System.out.println("::::::::::::: copiarDirectorios d1= " + d1 + " d2= " + d2);
        File origen = new File(d1);
        File destino = new File(d2);
        boolean creado = false;
        if (origen.isDirectory()) {
            System.out.println("::::::::::::: origen.isDirectory() " + origen.isDirectory());
