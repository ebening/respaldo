...
import com.admon.entity.admon.NombreContra;

public class NombreContraDAO extends GenericDAOImpl<NombreContra, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<NombreContra> getEntityClass() {
        return NombreContra.class;
    }
}
