...
import com.admon.entity.admon.OrganizacionGenerar;

public class OrganizacionGenerarDAO extends GenericDAOImpl<OrganizacionGenerar, Integer> {
 ...
 * @return Regresa un objeto <b>Class</b> que identifica el tipo genérico. */
    @Override
    protected Class<OrganizacionGenerar> getEntityClass() {
        return OrganizacionGenerar.class;
    }
}
